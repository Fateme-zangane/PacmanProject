...
while not done:
   ...
   # print(score)
    ...
    if framecount == 0:
        ...
        print("ASTART number of expanded Nodes GREENGHOST: ", numExpanded)
        print("ASTART number of total Nodes GREENGHOST: ", totalNodes)
        print("ASTART computation time GREENGHOST: ", compTimeEnd - compTimeStart)

        compTimeStart = time.time()
        REDGHOST.goal_cell,numExpanded,totalNodes = aStarGhost(REDGHOST, pacman, cells)
        compTimeEnd = time.time()
        print("ASTART number of expanded Nodes REDGHOST: ", numExpanded)
        print("ASTART number of total Nodes REDGHOST: ", totalNodes)
        print("ASTART computation time REDGHOST: ", compTimeEnd - compTimeStart)
        ...
        """ Uncomment To Use aStarGhost for GREENGHOST
        compTimeStart = time.time()
        ORANGEGHOST.goal_cell,numExpanded,totalNodes = aStarGhost(ORANGEGHOST, pacman, cells)
        compTimeEnd = time.time()
        print("ASTART number of expanded Nodes ORANGEGHOST: ", numExpanded)
