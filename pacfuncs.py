    ...
    while len(Open) > 0:
        ...
        if rightbool:
            if cells[right.gridloc[0]][right.gridloc[1]].traversable == False:
                ...
                right.h = manhattan_distance(right.gridloc, goalNode.gridloc)
        ...
        if leftbool:
            if cells[left.gridloc[0]][left.gridloc[1]].traversable == False:
                ...
                left.h = manhattan_distance(left.gridloc, goalNode.gridloc)
        ...
        if upbool:
            if cells[up.gridloc[0]][up.gridloc[1]].traversable == False:
                ...
                up.g = up.parent.g + 1
                up.h = manhattan_distance(up.gridloc, goalNode.gridloc)
                up.f = up.g + up.h
            Open.append(up)
        if downbool:
            if cells[down.gridloc[0]][down.gridloc[1]].traversable == False:
                ...
                down.h = manhattan_distance(down.gridloc, goalNode.gridloc)
